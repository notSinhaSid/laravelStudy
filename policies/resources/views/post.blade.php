        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div style="display: flex; gap: 24px; align-items: flex-start;">
                ...
                <div style="flex: 1; background: linear-gradient(135deg, #dbeafe 0%, #bfdbfe 100%); border: 2px solid #93c5fd; border-radius: 12px; box-shadow: 0 10px 15px rgba(0, 0, 0, 0.1); overflow: hidden;">
                    <h1 style="padding: 24px; font-size: 24px; font-weight: bold; color: #1e40af; margin: 0;">Create Post</h1>
                    <hr style="border: none; border-top: 2px solid #93c5fd; margin: 0;">
                    
                    <form action="{{route('create-post')}}" method="POST" style="width: 100%; padding: 24px;">
                        @csrf
                        <div style="margin-bottom: 24px;">
                            ...
                            <input type="text" style="border: 2px solid #93c5fd; border-radius: 8px; width: 100%; padding: 12px 16px; background-color: white; color: #1e3a8a; outline: none; box-sizing: border-box;" id="title" onfocus="this.style.borderColor='#3b82f6'" onblur="this.style.borderColor='#93c5fd'" name="title">
                        </div>
                        <div style="margin-bottom: 24px;">
                            ...
                            <textarea style="border: 2px solid #93c5fd; border-radius: 8px; width: 100%; padding: 12px 16px; background-color: white; color: #1e3a8a; outline: none; height: 128px; resize: vertical; box-sizing: border-box;" id="content" onfocus="this.style.borderColor='#3b82f6'" onblur="this.style.borderColor='#93c5fd'" name="content"></textarea>
                        </div>
                        <div class="flex justify-end space-x-3">
                            <button type="submit" style="background-color: #1d4ed8; color: white; padding: 12px 40px; border-radius: 8px; font-weight: bold; border: none; cursor: pointer; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);" onmouseover="this.style.backgroundColor='#1e40af'" onmouseout="this.style.backgroundColor='#1d4ed8'" name="create">
                                Create Post
                            </button>
                        </div>
                    </form>
