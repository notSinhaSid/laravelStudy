...
//report route
// Route::get('/report',[ReportController::class,'showReport'])->name('report')->middleware('construction');
...
// creating route for rolechek
Route::get('/admin/{role}',[RoleController::class,'show'])->name('ad')->middleware('role:admin');